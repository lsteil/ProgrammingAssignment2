...
## The makeCacheMatrix is a function to create a special matrix object that can 
##cache its inverse.
...
## The cacheSolve function is a function to compute the inverse of the special 
